...
export default function MentorCard({ mentor }: { mentor: Mentor }) {
  ...
  return (
    <Card className="bg-primary-faded relative z-[2] rounded-md border border-primary-faded text-white overflow-hidden transition-all duration-300 hover:border-white cursor-pointer hover:-translate-y-1 hover:shadow-xl">
